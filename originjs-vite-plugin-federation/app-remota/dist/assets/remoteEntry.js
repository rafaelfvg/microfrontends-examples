...
const currentImports = {};
      ...
      let moduleMap = {
"./HolaMundo":()=>{
      dynamicLoadingCss([], false, './HolaMundo');
      return __federation_import('./__federation_expose_HolaMundo-8be87876.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__app_remota__' + exposeItemName;
