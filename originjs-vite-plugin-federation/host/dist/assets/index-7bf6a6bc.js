...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-57f88920.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-a7434114.js', import.meta.url).href),import:true}};
...
const RemoteWrapper = ({ module, scope }) => {
  ...
  if (error)
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Error al cargar el componente remoto: ",
      error.message
    ] });
  return Component ? /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Cargando..." });
};

await importShared('react');
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "¡Hola desde el Host!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RemoteWrapper, { scope: "app_remota", module: "./HolaMundo" })
  ] });
};
